    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seekBar1.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            private void makeRequest1() {
                try {
                    String url = "http://114.71.220.74:2018/set/1/" + URLEncoder.encode(String.valueOf(seekBar1.getProgress()), "UTF-8");
        ...
        seekBar2.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            private void makeRequest2() {
                try {
                    String url = "http://114.71.220.74:2018/set/2/" + URLEncoder.encode(String.valueOf(seekBar2.getProgress()), "UTF-8");
        ...
        seekBar3.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            private void makeRequest3() {
                try {
                    String url = "http://114.71.220.74:2018/set/3/" + URLEncoder.encode(String.valueOf(seekBar3.getProgress()), "UTF-8");
        ...
        seekBar4.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            private void makeRequest4() {
                try {
                    String url = "http://114.71.220.74:2018/set/4/" + URLEncoder.encode(String.valueOf(seekBar4.getProgress()), "UTF-8");
        ...
        seekBar5.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            private void makeRequest5() {
                try {
                    String url = "http://114.71.220.74:2018/set/5/" + URLEncoder.encode(String.valueOf(seekBar5.getProgress()), "UTF-8");
